...
initial
   begin
      $display(" ===============================================");
      $display("|       EMBENCH IOT BENCHMARK: WIKISORT         |");
      $display(" ===============================================");
      ...
      $display("");
      $display("INFO-VERILOG: Be patient... there could be up to 2 seconds of simulation time until until the benchmark starts.");
      $display("");
