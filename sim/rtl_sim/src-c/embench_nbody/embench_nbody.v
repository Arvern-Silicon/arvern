...
initial
   begin
      $display(" ===============================================");
      $display("|       EMBENCH IOT BENCHMARK: NBODY            |");
      $display(" ===============================================");
      ...
      $display("");
      $display("INFO-VERILOG: Be patient... there could be up to 5 seconds of simulation time until until the benchmark starts.");
      $display("");
