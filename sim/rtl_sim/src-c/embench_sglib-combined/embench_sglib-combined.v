...
//         / \__/ \          Test:      embench_sglib-combined
//        /   /\   \         --------------------------------------------
...
initial
   begin
      $display(" ===============================================");
      $display("|       EMBENCH IOT BENCHMARK: SGLIB-COMBINED   |");
      $display(" ===============================================");
      ...
      $display("");
      $display("INFO-VERILOG: Be patient... there could be up to 200 ms of simulation time until until the benchmark starts.");
      $display("");
