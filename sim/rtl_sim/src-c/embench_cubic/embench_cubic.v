...
initial
   begin
      $display(" ===============================================");
      $display("|          EMBENCH IOT BENCHMARK: CUBIC         |");
      $display(" ===============================================");
      ...
      $display("");
      $display("INFO-VERILOG: Be patient... there could be up to 1 second of simulation time until until the benchmark starts.");
      $display("");
      ...
      $display("");
      $display("INFO-VERILOG: Be patient... there could be up to 10 seconds to simulate for the benchmark to complete.");
      $display("");
