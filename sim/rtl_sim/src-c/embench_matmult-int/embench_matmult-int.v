...
initial
   begin
      $display(" ===============================================");
      $display("|       EMBENCH IOT BENCHMARK: MATMULT-INT      |");
      $display(" ===============================================");
      ...
      $display("");
      $display("INFO-VERILOG: Be patient... there could be up to 500 ms of simulation time until until the benchmark starts.");
      $display("");
