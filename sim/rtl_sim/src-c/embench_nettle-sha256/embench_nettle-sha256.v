...
initial
   begin
      $display(" ===============================================");
      $display("|       EMBENCH IOT BENCHMARK: NETTLE-SHA256    |");
      $display(" ===============================================");
      ...
      //$display("");
      //$display("INFO-VERILOG: Be patient... there could be up to 100 ms of simulation time until until the benchmark starts.");
      //$display("");
