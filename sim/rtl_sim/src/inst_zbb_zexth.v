...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|             CHECK REGISTER VALUES BEFORE ZEXT.H TESTS             |");
      $display(" ====================================================================");
      ...
      check_cpu_reg(3,  32'h00007FFF);   // 0x7FFF
      check_cpu_reg(4,  32'h00008000);   // 0x8000
      check_cpu_reg(5,  32'h0000FFFF);   // 0xFFFF
      ...
      $display("");
      $display(" ====================================================================");
      $display("|             CHECK REGISTER VALUES AFTER ZEXT.H TESTS              |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
      ...
      // After ZEXT.H tests, check final register state
