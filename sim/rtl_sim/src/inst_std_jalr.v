...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                     JALR TEST (Self-Checking)                      |");
      $display(" ====================================================================");
      ...
      if (probes_cpu.x31 == 32'hBADC0DE0) begin
          ...
          $display("----------------------------------------------------------------------");
          $display("Actual   (x11):    0x%08h  (value under test)", probes_cpu.x11);
          $display("Expected (x28):    0x%08h  (expected value)", probes_cpu.x28);
          $display("======================================================================");
          $display("");
          stimulus_done = 1;
          $finish;
      ...
      $display("");
      $display("Test PASSED - All JALR operations completed successfully");
      $display("");
