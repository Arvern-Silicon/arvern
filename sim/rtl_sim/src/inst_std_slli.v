...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES BEFORE THE SLLI              |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES AFTER THE SLLI               |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
	  ...
	  check_cpu_reg(1,  32'h80000001);
 	  check_cpu_reg(2,  32'h12345678);
 	  check_cpu_reg(3,  32'h00000002);
 	  check_cpu_reg(4,  32'h00000110);
	  check_cpu_reg(5,  32'h00000080);
	  check_cpu_reg(6,  32'h80000000);
	  check_cpu_reg(7,  32'hFFFFFFFE);
	  check_cpu_reg(8,  32'h00000002);
	  check_cpu_reg(9,  32'hFFFFFFFF);
	  check_cpu_reg(10, 32'hFFFFFFFF);
	  check_cpu_reg(11, 32'hFFFFFFFF);
	  check_cpu_reg(12, 32'hFFFFFFFF);
