...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES BEFORE THE SRA               |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES AFTER THE SRA                |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
	  ...
	  check_cpu_reg(1,  32'h12345678);
 	  ...
 	  check_cpu_reg(3,  32'h12345678);    // shift by 0
 	  check_cpu_reg(4,  32'h12345678);
	  check_cpu_reg(5,  32'h00000004);
	  check_cpu_reg(6,  32'h01234567);    // positive shift
	  check_cpu_reg(7,  32'hFFFFFFFF);
	  check_cpu_reg(8,  32'h00000001);
	  check_cpu_reg(9,  32'hFFFFFFFF);    // -1 >> 1 = -1
	  check_cpu_reg(10, 32'hFFFFFFFE);
	  check_cpu_reg(11, 32'h00000001);
	  check_cpu_reg(12, 32'hFFFFFFFF);    // -2 >> 1 = -1
	  check_cpu_reg(13, 32'hFFFFFFF8);
	  check_cpu_reg(14, 32'h00000002);
	  check_cpu_reg(15, 32'hFFFFFFFE);    // -8 >> 2 = -2
	  check_cpu_reg(16, 32'h80000000);
	  check_cpu_reg(17, 32'h00000001);
	  check_cpu_reg(18, 32'hC0000000);    // sign extended
	  check_cpu_reg(19, 32'h80000000);
	  check_cpu_reg(20, 32'h0000001F);
	  check_cpu_reg(21, 32'hFFFFFFFF);    // edge shift
	  check_cpu_reg(22, 32'h12345678);
	  check_cpu_reg(23, 32'h0000000C);
	  check_cpu_reg(24, 32'h00012345);    // positive >> 12
	  check_cpu_reg(25, 32'hEDCBA988);    // -305419896
	  check_cpu_reg(26, 32'h0000000C);
	  check_cpu_reg(27, 32'hFFFEDCBA);    // negative >> 12 (sign extended)
	  check_cpu_reg(28, 32'hFFFFFFFF);
	  check_cpu_reg(29, 32'hFFFFFFFF);
	  check_cpu_reg(30, 32'hFFFFFFFF);
