   ...
   begin
      ...
      repeat(3) @(posedge free_clk);
	   ...
	   check_cpu_reg(1,  32'h00004FED);
 	   ...
 	   check_cpu_reg(3,  32'h0000800F);
 	   check_cpu_reg(4,  32'h00009CCB);
	   check_cpu_reg(5,  32'h0000C887);
	   check_cpu_reg(6,  32'h0000D443);
	   ...
	   check_cpu_reg(16, 32'h0000bFFF);
	   check_cpu_reg(17, 32'h00005DDD);
	   check_cpu_reg(18, 32'h00007451);
	   check_cpu_reg(19, 32'h0000B234);
	   check_cpu_reg(20, 32'h0000Fead);
	   check_cpu_reg(21, 32'h00004021);
	   check_cpu_reg(22, 32'h0000Cbcd);
	   check_cpu_reg(23, 32'h0000Bbad);
	   check_cpu_reg(24, 32'h00003012);
	   check_cpu_reg(25, 32'h0000Efff);
	   check_cpu_reg(26, 32'h00000000);
