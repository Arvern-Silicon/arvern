...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|             CHECK REGISTER VALUES BEFORE BINV TESTS              |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|             CHECK REGISTER VALUES AFTER BINV TESTS               |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
      ...
      // After BINV tests, check final register state
      ...
      // x3: Test 23 result - binv(0x7FFFFFFF, 30)
      check_cpu_reg(3, 32'h3FFFFFFF);

      // x4: Test 24 result - binv(0x12345678, 16)
      check_cpu_reg(4, 32'h12355678);

      // x5: Test 25 result - binv(0xAAAAAAAA, 25)
      check_cpu_reg(5, 32'hA8AAAAAA);

      // x6: Test 26 result - binv(0x55555555, 0)
      check_cpu_reg(6, 32'h55555554);

      // x7: Test 27 result - binv(0xF0F0F0F0, 29)
      check_cpu_reg(7, 32'hD0F0F0F0);

      // x8: Test 28 result - binv(0x00000003, 3)
      check_cpu_reg(8, 32'h0000000B);

      // x9: Test 29 result - binv(0x55555555, 17)
      check_cpu_reg(9, 32'h55575555);

      // x10: Test 30 result - binv(0xFEDCBA98, 22)
      check_cpu_reg(10, 32'hFE9CBA98);

      // x11: Test 1 result - binv(0xFFFFFFFF, 0)
      check_cpu_reg(11, 32'hFFFFFFFE);

      // x12: Test 2 result - binv(0xFFFFFFFF, 31)
      check_cpu_reg(12, 32'h7FFFFFFF);

      // x13: Test 3 result - binv(0xFFFFFFFF, 15)
      check_cpu_reg(13, 32'hFFFF7FFF);

      // x14: Test 4 result - binv(0x00000000, 0)
      check_cpu_reg(14, 32'h00000001);

      // x15: Test 5 result - binv(0x12345678, 8)
      check_cpu_reg(15, 32'h12345778);

      // x16: Test 6 result - binv(0x12345678, 10)
      check_cpu_reg(16, 32'h12345278);

      // x17: Test 7 result - binv(0xAAAAAAAA, 4)
      check_cpu_reg(17, 32'hAAAAAABA);

      // x18: Test 8 result - binv(0xAAAAAAAA, 7)
      check_cpu_reg(18, 32'hAAAAAA2A);

      // x19: Test 9 result - binv(0x55555555, 12)
      check_cpu_reg(19, 32'h55554555);

      // x20: Test 10 result - binv(0x55555555, 16)
      check_cpu_reg(20, 32'h55545555);

      // x21: Test 11 result - binv(0x80000000, 31)
      check_cpu_reg(21, 32'h00000000);

      // x22: Test 12 result - binv(0x00000001, 0)
      check_cpu_reg(22, 32'h00000000);

      // x23: Test 13 result - binv(0xF0F0F0F0, 7)
      check_cpu_reg(23, 32'hF0F0F070);

      // x24: Test 14 result - binv(0xF0F0F0F0, 3)
      check_cpu_reg(24, 32'hF0F0F0F8);

      // x25: Test 15 result - binv(0x0F0F0F0F, 20)
      check_cpu_reg(25, 32'h0F1F0F0F);

      // x26: Test 16 result - binv(0x0F0F0F0F, 24)
      check_cpu_reg(26, 32'h0E0F0F0F);

      // x27: Test 17 result - binv(0xDEADBEEF, 1)
      check_cpu_reg(27, 32'hDEADBEED);

      // x28: Test 18 result - binv(0xDEADBEEF, 5)
      check_cpu_reg(28, 32'hDEADBECF);

      // x29: Test 19 result - binv(0xDEADBEEF, 20)
      check_cpu_reg(29, 32'hDEBDBEEF);

      // x30: Test 20 result - binv(0xDEADBEEF, 27)
