...
//----------------------------------------------------------------------------
// Description: ECALL
//   Comprehensive trap handling verification:
//   - MCAUSE correctness (cause 11 = ECALL from M-mode)
//   - MEPC save (points to ecall instruction)
//   - MSTATUS save/restore (MIE, MPIE, MPP)
//   - MTVEC configuration
//   - MRET return to correct PC
//   - Multiple consecutive ECALLs
//   - Back-to-back ECALLs
//   - Pipeline stress (load/store/ALU before ECALL)
...
initial
   begin
      ...
      // Disable error-on-exception for this test (ECALL is intentional)
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 PHASE 2: FIRST ECALL - BASIC TRAP ENTRY/EXIT       |");
      $display(" ====================================================================");
      $display("");
      $display("Waiting for the firmware...");
      ...
      // Check MCAUSE = 11 (Environment call from M-mode)
      check_mem_value(`SPAD(32'h04), 32'h0000000B);

      // Check MEPC matches expected (firmware stored the ecall PC)
      // Compare trap1_mepc against expected_mepc1
      $display("");
      ...
      //=================================================================
      // PHASE 3: Second ECALL - consecutive traps
      //=================================================================
      $display("");
      $display("");
      $display(" ====================================================================");
      $display("|                 PHASE 3: SECOND ECALL - CONSECUTIVE TRAPS          |");
      $display(" ====================================================================");
      $display("");
      $display("Waiting for the firmware...");
      ...
      // Check ALU results survived the ECALL (computed before 2nd ecall)
      $display("");
      $display("--- ALU results after ECALL ---");
      ...
      $display("");
      $display("--- Register preservation (after 2nd ECALL) ---");
      check_cpu_reg(18, 32'hAAAAAAAA);   // s2
      check_cpu_reg(19, 32'hBBBBBBBB);   // s3
      check_cpu_reg(20, 32'hCCCCCCCC);   // s4
      check_cpu_reg(21, 32'hDDDDDDDD);   // s5
      ...
      //=================================================================
      // PHASE 4: Back-to-back ECALLs
      //=================================================================
      $display("");
      $display("");
      $display(" ====================================================================");
      $display("|                 PHASE 4: BACK-TO-BACK ECALLS                       |");
      $display(" ====================================================================");
      $display("");
      $display("Waiting for the firmware...");
      ...
      check_mem_value(`SPAD(32'h28), 32'h0000000B);   // trap3
      check_mem_value(`SPAD(32'h30), 32'h0000000B);   // trap4


      //=================================================================
      // PHASE 5: Pipeline stress + final checks
      //=================================================================
      $display("");
      $display("");
      $display(" ====================================================================");
      $display("|                 PHASE 5: PIPELINE STRESS + FINAL CHECKS            |");
      $display(" ====================================================================");
      $display("");
      $display("Waiting for the firmware...");
