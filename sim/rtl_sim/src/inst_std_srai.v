...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES BEFORE THE SRAI              |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES AFTER THE SRAI               |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
	  ...
	  check_cpu_reg(1,  32'hC000FF00);
 	  check_cpu_reg(2,  32'h12345678);
 	  check_cpu_reg(3,  32'h20000000);
 	  check_cpu_reg(4,  32'hFFFFFFFF);
	  check_cpu_reg(5,  32'hFFFFFFFF);
	  check_cpu_reg(6,  32'hFFFFFFFF);
	  check_cpu_reg(7,  32'hFF8001FE);
	  check_cpu_reg(8,  32'hFFFFFFFF);
	  check_cpu_reg(9,  32'hFFFFFFFF);
	  check_cpu_reg(10, 32'hFFFFFFFF);
	  check_cpu_reg(11, 32'hFFFFFFFF);
