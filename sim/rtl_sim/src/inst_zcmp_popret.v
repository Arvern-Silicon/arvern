...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|           CHECK INITIAL REGISTER VALUES (CM.POPRET TEST)           |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|            CHECK RESULTS AFTER CM.POPRET TESTS                     |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
      ...
      $display("");
      $display("Test PASSED - All CM.POPRET operations completed successfully");
      $display("");

      // Verify final SP value (after Test 17 stress loop: SP = 0x8000FE00)
      check_cpu_reg(2, 32'h8000FE00);

      // Verify final register values from Test 17 last iteration (iter=19, 0x13)
      // Values: 0x17000000 | (19 << 4) | reg_id = 0x17000130 | reg_id
      check_cpu_reg(8,  32'h17000132);  // s0
      check_cpu_reg(9,  32'h17000133);  // s1
      check_cpu_reg(18, 32'h17000134);  // s2
      check_cpu_reg(19, 32'h17000135);  // s3
      check_cpu_reg(20, 32'h17000136);  // s4
      check_cpu_reg(21, 32'h17000137);  // s5
      check_cpu_reg(22, 32'h17000138);  // s6
      check_cpu_reg(23, 32'h17000139);  // s7
      check_cpu_reg(24, 32'h1700013A);  // s8
      check_cpu_reg(25, 32'h1700013B);  // s9
      check_cpu_reg(26, 32'h1700013C);  // s10
      check_cpu_reg(27, 32'h1700013D);  // s11
