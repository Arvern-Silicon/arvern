...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES BEFORE THE AND               |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES AFTER THE AND                |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
	  ...
	  check_cpu_reg(1,  32'h12345678);
 	  ...
 	  check_cpu_reg(3,  32'h00000000);   // AND with 0
 	  check_cpu_reg(4,  32'hFFFFFFFF);
	  check_cpu_reg(5,  32'hFFFFFFFF);   // AND with itself
	  check_cpu_reg(6,  32'hAAAAAAAA);
	  check_cpu_reg(7,  32'h55555555);
	  check_cpu_reg(8,  32'h00000000);   // non-overlapping patterns
	  check_cpu_reg(9,  32'hFFFFFFFF);
	  check_cpu_reg(10, 32'h00000001);
	  check_cpu_reg(11, 32'h00000001);   // -1 & 1
	  check_cpu_reg(12, 32'h80000000);
	  check_cpu_reg(13, 32'h7FFFFFFF);
	  check_cpu_reg(14, 32'h00000000);   // edge case
	  check_cpu_reg(15, 32'h12345678);
	  check_cpu_reg(16, 32'h87654321);
	  check_cpu_reg(17, 32'h02244220);   // random AND
	  check_cpu_reg(18, 32'h0000FFFF);
	  check_cpu_reg(19, 32'h12345678);
	  check_cpu_reg(20, 32'h00005678);   // masked value
	  check_cpu_reg(21, 32'hF0F0F0F0);
	  check_cpu_reg(22, 32'h0F0F0F0F);
	  check_cpu_reg(23, 32'h00000000);   // overlapping pattern AND
	  check_cpu_reg(24, 32'hFFFFFFFF);
	  check_cpu_reg(25, 32'hFFFFFFFF);
	  check_cpu_reg(26, 32'hFFFFFFFF);
	  check_cpu_reg(27, 32'hFFFFFFFF);
