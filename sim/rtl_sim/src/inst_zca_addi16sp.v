...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES BEFORE THE C.ADDI16SP        |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
      $display("");
      $display("Waiting for the firmware...");

      @(probes_cpu.x02==32'h20000400);

	   check_cpu_reg(1,  32'hDEADBEEF);
 	   check_cpu_reg(2,  32'h20000400);   // sp
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES AFTER THE C.ADDI16SP         |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
	  ...
	  // C.ADDI16SP tests - sp modified by various signed immediates (multiples of 16)
	  // Initial sp = 0x20000400
	  // After all operations:
	  //   +16, +32, +64, +128, +256, +496, -16, -32, -64, -128, -256, -512,
	  //   +48, -48, +80, -80, +112, -112, +240, -240
	  // Net result: 0x20000400 + (16+32+64+128+256+496-16-32-64-128-256-512+48-48+80-80+112-112+240-240)
	  //           = 0x20000400 + (992 - 1008) = 0x20000400 - 16 = 0x200003F0

	  check_cpu_reg(1,  32'hDEADBEEF);   // Unchanged marker
	  check_cpu_reg(2,  32'h200003F0);   // sp = 0x20000400 - 16

	  // All other registers should remain unchanged at 0
	  check_cpu_reg(3,  32'h00000000);
	  check_cpu_reg(4,  32'h00000000);
	  check_cpu_reg(5,  32'h00000000);
	  check_cpu_reg(6,  32'h00000000);
