...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES BEFORE THE CSRRWI            |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES AFTER THE CSRRWI             |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
      ...
      @(probes_cpu.x31==32'hdeadbeef);
	   ...
	   check_cpu_reg(12, 32'h00000011);
	   check_cpu_reg(13, 32'h0000001F);
	   check_cpu_reg(14, 32'h00000005);
	   check_cpu_reg(15, 32'h0000000C);
	   check_cpu_reg(16, 32'h0000001C);
	   check_cpu_reg(17, 32'h00000001);
	   check_cpu_reg(18, 32'h00000018);
	   check_cpu_reg(19, 32'hffffffff);
	   check_cpu_reg(20, 32'hffffffff);
	   check_cpu_reg(21, 32'h00000007);
	   check_cpu_reg(22, 32'h00000013);
	   check_cpu_reg(23, 32'h00000002);
	   check_cpu_reg(24, 32'h00000019);
	   check_cpu_reg(25, 32'h0000000E);
	   check_cpu_reg(26, 32'h0000001F);
