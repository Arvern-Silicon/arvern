...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|               CHECK REGISTER VALUES BEFORE MIN TESTS              |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|               CHECK REGISTER VALUES AFTER MIN TESTS               |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
      ...
      // After MIN tests, check final register state
      ...
      // x6: Test 22 result - min(1000000, 2000000) = 1000000
      check_cpu_reg(6, 32'h000F4240);
      ...
      // x9: Test 23 result - min(-1000000, -2000000) = -2000000
      check_cpu_reg(9, 32'hFFE17B80);
      ...
      // x12: Test 24 result - min(99, 100) = 99
      check_cpu_reg(12, 32'h00000063);
      ...
      // x15: Test 25 result - min(-100, -99) = -100
      check_cpu_reg(15, 32'hFFFFFF9C);
      ...
      // x18: Test 26 result - min(128, 256) = 128
      check_cpu_reg(18, 32'h00000080);
      ...
      // x21: Test 27 result - min(-128, -256) = -256
      check_cpu_reg(21, 32'hFFFFFF00);
      ...
      // x24: Test 28 result - min(50, -100) = -100
      check_cpu_reg(24, 32'hFFFFFF9C);
      ...
      // x27: Test 29 result - min(INT_MAX, INT_MAX) = INT_MAX
      ...
      // x30: Test 30 result - min(INT_MIN, INT_MIN) = INT_MIN
