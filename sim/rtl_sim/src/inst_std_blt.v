...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES BEFORE THE BLT               |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES AFTER THE BLT                |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
	  ...
	  check_cpu_reg(1,  32'h00000005);
 	  check_cpu_reg(2,  32'h00000005);
 	  check_cpu_reg(3,  32'h00000005);
 	  check_cpu_reg(4,  32'h00000019);
	  check_cpu_reg(5,  32'h0000001E);
	  check_cpu_reg(6,  32'h000000FF);
	  check_cpu_reg(7,  32'h00000005);
	  check_cpu_reg(8,  32'h00000005);
	  check_cpu_reg(9,  32'h0000000A);
	  check_cpu_reg(10, 32'h00000000);
	  ...
	  check_cpu_reg(24, 32'h00000001);
	  check_cpu_reg(25, 32'h00000001);
	  check_cpu_reg(26, 32'h00000005);
	  check_cpu_reg(27, 32'h00000001);
	  check_cpu_reg(28, 32'h00000000);
	  check_cpu_reg(29, 32'h00000001);
	  check_cpu_reg(30, 32'hFFFFFFFF);
