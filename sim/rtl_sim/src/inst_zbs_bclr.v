...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|             CHECK REGISTER VALUES BEFORE BCLR TESTS              |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|             CHECK REGISTER VALUES AFTER BCLR TESTS               |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
      ...
      // After BCLR tests, check final register state
      // BCLR operation: rd = rs1 & ~(1 << rs2[4:0])

      // x1: Test 21 result - bclr(0xFFFFFFFF, 32) uses bit 0
      check_cpu_reg(1, 32'hFFFFFFFE);

      // x2: Test 22 final result - after clearing bits 4, 5, 6
      check_cpu_reg(2, 32'hFFFFFF8F);

      // x3: Test 23 result - bclr(0x00000001, 0)
      check_cpu_reg(3, 32'h00000000);

      // x4: Test 24 result - bclr(0x80000000, 31)
      check_cpu_reg(4, 32'h00000000);

      // x5: Test 25 final result - after clearing bits 3, 6, 9
      check_cpu_reg(5, 32'h12345430);

      // x6: Test 26 result - bclr(0xFFFF0000, 16)
      check_cpu_reg(6, 32'hFFFE0000);

      // x7: Test 27 result - bclri(0x00000000, 15)
      check_cpu_reg(7, 32'h00000000);

      // x8: Test 28 result - bclri(0x7FFFFFFF, 30)
      check_cpu_reg(8, 32'h3FFFFFFF);

      // x9: Test 29 result - bclr(0xF0F0F0F0, 15)
      check_cpu_reg(9, 32'hF0F070F0);

      // x10: Test 30 result - bclri(0x55AA55AA, 17)
      check_cpu_reg(10, 32'h55A855AA);

      // x11: Test 1 result - bclr(0xFFFFFFFF, 0)
      check_cpu_reg(11, 32'hFFFFFFFE);

      // x12: Test 2 result - bclr(0xFFFFFFFF, 31)
      check_cpu_reg(12, 32'h7FFFFFFF);

      // x13: Test 3 result - bclr(0xFFFFFFFF, 15)
      check_cpu_reg(13, 32'hFFFF7FFF);

      // x14: Test 4 result - bclr(0x00000000, 0)
      check_cpu_reg(14, 32'h00000000);

      // x15: Test 5 result - bclr(0x12345678, 10)
      ...
      // x18: Test 8 result - bclr(0xF0F0F0F0, 7)
      check_cpu_reg(18, 32'hF0F0F070);

      // x19: Test 9 result - bclr(0x0F0F0F0F, 24)
      check_cpu_reg(19, 32'h0E0F0F0F);

      // x20: Test 10 result - bclr(0xDEADBEEF, 20)
      check_cpu_reg(20, 32'hDEADBEEF);

      // x21: Test 11 result - bclri(0xFFFFFFFF, 0)
      check_cpu_reg(21, 32'hFFFFFFFE);

      // x22: Test 12 result - bclri(0xFFFFFFFF, 31)
      check_cpu_reg(22, 32'h7FFFFFFF);

      // x23: Test 13 result - bclri(0x12345678, 8)
      check_cpu_reg(23, 32'h12345678);

      // x24: Test 14 result - bclri(0xAAAAAAAA, 4)
      check_cpu_reg(24, 32'hAAAAAAAA);

      // x25: Test 15 result - bclri(0x55555555, 12)
      check_cpu_reg(25, 32'h55554555);

      // x26: Test 16 result - bclri(0xF0F0F0F0, 3)
      check_cpu_reg(26, 32'hF0F0F0F0);

      // x27: Test 17 result - bclri(0x0F0F0F0F, 20)
      check_cpu_reg(27, 32'h0F0F0F0F);

      // x28: Test 18 result - bclri(0xDEADBEEF, 1)
      check_cpu_reg(28, 32'hDEADBEED);

      // x29: Test 19 result - bclri(0x87654321, 27)
      check_cpu_reg(29, 32'h87654321);

      // x30: Test 20 result - bclri(0xABCDEF01, 16)
      check_cpu_reg(30, 32'hABCCEF01);
