...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|          CHECK INITIAL REGISTER VALUES (CM.MVA01S TEST)            |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|            CHECK RESULTS AFTER CM.MVA01S TESTS                     |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
      ...
      if (probes_cpu.x31 == 32'hBADC0DE0) begin
          ...
          $display("  (01 = a0 check, 02 = a1 check, 03+ = other)");
          $display("----------------------------------------------------------------------");
      ...
      $display("");
      $display("Test PASSED - All CM.MVA01S operations completed successfully");
      $display("");

      // Verify s-registers are at their distinctive values
      // (CM.MVA01S must not modify source registers)
