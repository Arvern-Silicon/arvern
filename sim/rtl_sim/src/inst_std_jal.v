...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                      JAL TEST (Self-Checking)                      |");
      $display(" ====================================================================");
      ...
      if (probes_cpu.x31 == 32'hBADC0DE0) begin
          ...
          $display("----------------------------------------------------------------------");
          $display("Actual   (rd):     0x%08h  (link register written by JAL)", probes_cpu.x11);
          $display("Expected (label):  0x%08h  (address after JAL, via x28)", probes_cpu.x28);
          $display("======================================================================");
          $display("");
          stimulus_done = 1;
          $finish;
      ...
      $display("");
      $display("Test PASSED - All JAL operations completed successfully");
      $display("");
