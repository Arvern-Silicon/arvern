...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES BEFORE THE CSRRCI            |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES AFTER THE CSRRCI             |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
      ...
      @(probes_cpu.x31==32'hdeadbeef);
	   ...
	   check_cpu_reg(9,  32'h00000000);
	   check_cpu_reg(10, 32'h10042000);
	   check_cpu_reg(11, 32'hFFFFFFFC);
	   check_cpu_reg(12, 32'hFFFFFFE8);
	   check_cpu_reg(13, 32'hFFFFFFF3);
	   check_cpu_reg(14, 32'hFFFFFFF9);
	   check_cpu_reg(15, 32'hFFFFFFED);
	   check_cpu_reg(16, 32'hFFFFFFE7);
	   check_cpu_reg(17, 32'hFFFFFFFE);
	   check_cpu_reg(18, 32'hFFFFFFEB);
	   check_cpu_reg(19, 32'h00000000);
	   check_cpu_reg(20, 32'h00000000);
	   check_cpu_reg(21, 32'hFFFFFFF4);
	   check_cpu_reg(22, 32'hFFFFFFE0);
	   check_cpu_reg(23, 32'hFFFFFFE1);
	   check_cpu_reg(24, 32'hFFFFFFE8);
	   check_cpu_reg(25, 32'hFFFFFFE9);
	   check_cpu_reg(26, 32'hFFFFFFE6);
	   check_cpu_reg(27, 32'hFFFFFFF6);
	   check_cpu_reg(28, 32'hFFFFFFEA);
	   check_cpu_reg(29, 32'h00000000);
	   check_cpu_reg(30, 32'h00000000);
