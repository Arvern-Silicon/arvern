...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES BEFORE THE ORI               |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES AFTER THE ORI                |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);

      $display("");
      $display("Waiting for the firmware...");
      @(probes_cpu.x31==32'hdeadbeef);          // Wait for last SW instruction (to first Periph #0 word)
	  ...
	  check_cpu_reg(1,  32'h00000000);
 	  ...
 	  check_cpu_reg(3,  32'hFFFFFFFF);
 	  check_cpu_reg(4,  32'h1234567F);
	  check_cpu_reg(5,  32'hFFFFFAFF);
	  check_cpu_reg(6,  32'h00000123);
	  check_cpu_reg(7,  32'hFFFFFFFF);
	  check_cpu_reg(8,  32'hFFFFFFFF);
	  check_cpu_reg(9,  32'hFFFFFFFF);
	  check_cpu_reg(10, 32'hFFFFFFFF);
