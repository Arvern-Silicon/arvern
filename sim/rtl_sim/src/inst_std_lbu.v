...
initial
   begin
      ...
      $display("");
      $display("Waiting for the firmware...");
      @(probes_cpu.x30==32'h0000009A);          // Wait for last LBU instruction
      ...
      repeat(3) @(posedge free_clk);
	   ...
	   check_cpu_reg(1,  32'h000000ED);
 	   check_cpu_reg(2,  32'h00000065);
 	   check_cpu_reg(3,  32'h0000000F);
 	   check_cpu_reg(4,  32'h000000CB);
	   check_cpu_reg(5,  32'h00000087);
	   check_cpu_reg(6,  32'h00000043);
	   check_cpu_reg(7,  32'h00000035);
	   check_cpu_reg(8,  32'h00000024);
	   check_cpu_reg(9,  32'h0000009A);
	   check_cpu_reg(10, 32'h0000009A);
	   check_cpu_reg(11, 32'h00000012);
	   check_cpu_reg(12, 32'h000000DE);
	   check_cpu_reg(13, 32'h0000009A);
	   check_cpu_reg(14, 32'h00000056);
	   check_cpu_reg(15, 32'h00000012);
	   check_cpu_reg(16, 32'h000000FF);
	   check_cpu_reg(17, 32'h000000DD);
	   check_cpu_reg(18, 32'h00000051);
	   check_cpu_reg(19, 32'h00000034);
	   check_cpu_reg(20, 32'h000000ad);
	   check_cpu_reg(21, 32'h00000021);
	   check_cpu_reg(22, 32'h000000cd);
	   check_cpu_reg(23, 32'h000000ad);
	   check_cpu_reg(24, 32'h00000012);
	   check_cpu_reg(25, 32'h000000ff);
	   check_cpu_reg(26, 32'h00000009);
	   check_cpu_reg(27, 32'h000000AD);
	   check_cpu_reg(28, 32'h0000000B);

	   check_cpu_reg(29, 32'h80000010);
	   check_cpu_reg(30, 32'h0000009A);
	   check_cpu_reg(31, 32'h10041030);
