...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|          CHECK INITIAL REGISTER VALUES (CM.MVSA01 TEST)            |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|            CHECK RESULTS AFTER CM.MVSA01 TESTS                     |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
      ...
      if (probes_cpu.x31 == 32'hBADC0DE0) begin
          ...
          $display("  (01 = r1s' dest, 02 = r2s' dest, 03 = a0 preserved, 04 = a1 preserved)");
          $display("----------------------------------------------------------------------");
      ...
      $display("");
      $display("Test PASSED - All CM.MVSA01 operations completed successfully");
      $display("");

      // Verify s-registers are at their distinctive values
      // (all tests restore s-registers after checking)
      check_cpu_reg(8,  32'h80808080);  // s0
      check_cpu_reg(9,  32'h91919191);  // s1
      check_cpu_reg(18, 32'hA2A2A2A2);  // s2
      check_cpu_reg(19, 32'hB3B3B3B3);  // s3
      check_cpu_reg(20, 32'hC4C4C4C4);  // s4
      check_cpu_reg(21, 32'hD5D5D5D5);  // s5
      check_cpu_reg(22, 32'hE6E6E6E6);  // s6
      check_cpu_reg(23, 32'hF7F7F7F7);  // s7
