...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|              CHECK REGISTER VALUES BEFORE MAXU TESTS              |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|              CHECK REGISTER VALUES AFTER MAXU TESTS               |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
      ...
      // After MAXU tests, check final register state
      ...
      // x3: Test 21 result - maxu(0x80000000, 0x80000001) = 0x80000001
      check_cpu_reg(3, 32'h80000001);
      ...
      // x6: Test 22 result - maxu(0xF0000000, 0xE0000000) = 0xF0000000
      ...
      // x9: Test 23 result - maxu(0x10000000, 0x20000000) = 0x20000000
      check_cpu_reg(9, 32'h20000000);
      ...
      // x12: Test 24 result - maxu(128, 256) = 256
      ...
      // x15: Test 25 result - maxu(0xFF000000, 0x00FFFFFF) = 0xFF000000
      ...
      // x18: Test 26 result - maxu(99, 100) = 100
      check_cpu_reg(18, 32'h00000064);
      ...
      // x21: Test 27 result - maxu(0xFFFFFFFD, 0xFFFFFFFE) = 0xFFFFFFFE
      ...
      // x24: Test 28 result - maxu(0x40000000, 0x3FFFFFFF) = 0x40000000
      check_cpu_reg(24, 32'h40000000);
      ...
      // x27: Test 29 result - maxu(1000, 1001) = 1001
      check_cpu_reg(27, 32'h000003E9);
      ...
      // x30: Test 30 result - maxu(0xFFFFFFFF, 0xFFFFFFFF) = 0xFFFFFFFF
