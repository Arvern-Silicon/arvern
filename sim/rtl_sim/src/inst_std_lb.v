...
initial
   begin
      ...
      $display("");
      $display("Waiting for the firmware...");
      @(probes_cpu.x30==32'hFFFFFF9A);          // Wait for last LB instruction
