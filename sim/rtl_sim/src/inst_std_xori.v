...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES BEFORE THE XORI              |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES AFTER THE XORI               |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
	  ...
	  check_cpu_reg(1,  32'hFEDCBA98);
 	  ...
 	  check_cpu_reg(3,  32'hEDCBA987);
 	  check_cpu_reg(4,  32'h123456FF);
	  check_cpu_reg(5,  32'hFFFFFFFF);
	  check_cpu_reg(6,  32'hABCD1234);
	  check_cpu_reg(7,  32'hABCD1234);
	  check_cpu_reg(8,  32'h5432EDCB);
	  check_cpu_reg(9,  32'hFFFFFFFE);
	  check_cpu_reg(10, 32'h01234032);
	  check_cpu_reg(11, 32'hFFFFFFFF);
	  check_cpu_reg(12, 32'hFFFFFFFF);
	  check_cpu_reg(13, 32'hFFFFFFFF);
	  check_cpu_reg(14, 32'hFFFFFFFF);
