...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES BEFORE THE SRL               |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES AFTER THE SRL                |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
	  ...
	  check_cpu_reg(6,  32'h091A2B3C);   // shift by 1
	  check_cpu_reg(7,  32'h12345678);
	  check_cpu_reg(8,  32'h0000001F);
	  check_cpu_reg(9,  32'h00000000);   // shift by 31
	  check_cpu_reg(10, 32'hFFFFFFFF);
	  check_cpu_reg(11, 32'h00000001);
	  check_cpu_reg(12, 32'h7FFFFFFF);   // logical shift removes sign
	  check_cpu_reg(13, 32'h80000000);
	  check_cpu_reg(14, 32'h00000001);
	  check_cpu_reg(15, 32'h40000000);
	  check_cpu_reg(16, 32'hAAAAAAAA);
	  check_cpu_reg(17, 32'h00000004);
	  check_cpu_reg(18, 32'h0AAAAAAA);
	  check_cpu_reg(19, 32'hFFFFFFFF);
	  check_cpu_reg(20, 32'h00000008);
	  check_cpu_reg(21, 32'h00FFFFFF);
	  check_cpu_reg(22, 32'h12345678);
	  check_cpu_reg(23, 32'h0000000C);
	  check_cpu_reg(24, 32'h00012345);
	  check_cpu_reg(25, 32'hFFFFFFFF);
	  check_cpu_reg(26, 32'hFFFFFFFF);
	  check_cpu_reg(27, 32'hFFFFFFFF);
	  check_cpu_reg(28, 32'hFFFFFFFF);
