...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES BEFORE THE SLTU              |");
      $display(" ====================================================================");
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES AFTER THE SLTU               |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
	  ...
	  check_cpu_reg(1,  32'h00000003);   //  overwritten in test 11
 	  check_cpu_reg(2,  32'h00000000);   //  0xFFFFFFFF < 3? -> 0
 	  check_cpu_reg(3,  32'h00000003);   //  overwritten in test 12
 	  check_cpu_reg(4,  32'hFFFFFFFF);   //  overwritten in test 12
	  check_cpu_reg(5,  32'h00000001);   //  3 < 0xFFFFFFFF? -> 1
	  check_cpu_reg(6,  32'h00000001);   //  1 < 2 -> 1
	  check_cpu_reg(7,  32'h0000000A);   //  10
	  check_cpu_reg(8,  32'h00000003);   //  3
	  check_cpu_reg(9,  32'h00000000);   //  10 < 3 -> 0
	  check_cpu_reg(10, 32'hFFFFFFFF);   //  -1
	  check_cpu_reg(11, 32'h00000001);   //  1
	  check_cpu_reg(12, 32'h00000000);   //  0xFFFFFFFF < 1 -> 0
	  check_cpu_reg(13, 32'h00000001);   //  1
	  check_cpu_reg(14, 32'hFFFFFFFF);   //  -1
	  check_cpu_reg(15, 32'h00000001);   //  1 < 0xFFFFFFFF -> 1
	  check_cpu_reg(16, 32'h00000000);   //  0
	  check_cpu_reg(17, 32'h80000000);   //  0x80000000
	  check_cpu_reg(18, 32'h00000001);   //  0 < 0x80000000 -> 1
	  check_cpu_reg(19, 32'h80000000);   //  0x80000000
	  check_cpu_reg(20, 32'hFFFFFFFF);   //  0xFFFFFFFF
	  check_cpu_reg(21, 32'h00000001);   //  0x80000000 < 0xFFFFFFFF -> 1
	  check_cpu_reg(22, 32'hFFFFFFFF);   //  0xFFFFFFFF
	  check_cpu_reg(23, 32'h80000000);   //  0x80000000
	  check_cpu_reg(24, 32'h00000000);   //  0xFFFFFFFF < 0x80000000 -> 0
	  check_cpu_reg(25, 32'hFFFFFFFF);   //  0xFFFFFFFF
	  check_cpu_reg(26, 32'hFFFFFFFF);   //  0xFFFFFFFF
	  check_cpu_reg(27, 32'h00000000);   //  equal big numbers -> 0
	  check_cpu_reg(28, 32'h00000002);   //  2
	  check_cpu_reg(29, 32'h00000003);   //  3
	  check_cpu_reg(30, 32'h00000001);   //  2 < 3 -> 1
