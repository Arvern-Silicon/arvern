...
initial
   begin
      ...
      $display("");
      $display(" ====================================================================");
      $display("|                 CHECK REGISTER VALUES AFTER THE ADD                |");
      $display(" ====================================================================");
      repeat(3) @(posedge free_clk);
	  ...
	  check_cpu_reg(1,  32'h0000000A);
 	  check_cpu_reg(2,  32'h00000014);
 	  check_cpu_reg(3,  32'h0000001E);
 	  check_cpu_reg(4,  32'h000004D2);
	  check_cpu_reg(5,  32'hFFFFFB2E);
	  check_cpu_reg(6,  32'h00000000);
	  check_cpu_reg(7,  32'hFFFFFF9C);
	  check_cpu_reg(8,  32'hFFFFFF38);
	  check_cpu_reg(9,  32'hFFFFFED4);
	  check_cpu_reg(10, 32'h00000000);
	  check_cpu_reg(11, 32'hABCDEF01);
	  check_cpu_reg(12, 32'hABCDEF01);
	  check_cpu_reg(13, 32'hABCDEF01);
	  check_cpu_reg(14, 32'h7FFFFFFF);
	  check_cpu_reg(15, 32'h00000001);
	  check_cpu_reg(16, 32'h80000000);
	  check_cpu_reg(17, 32'h80000000);
	  check_cpu_reg(18, 32'hFFFFFFFF);
	  check_cpu_reg(19, 32'h7FFFFFFF);
	  check_cpu_reg(20, 32'h00000064);
	  check_cpu_reg(21, 32'hFFFFFFCE);
