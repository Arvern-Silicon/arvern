...
// deviation); HSIZE/HWRITE/HBURST stay enforced. Default 0 = fully strict.
    ...
    input  wire [8*64-1:0] bus_name_i,          // human-readable bus label for messages
    input  wire            hclk_i,              // the master's launch clock (dut_hclk)
    input  wire            hresetn_i,
    input  wire     [31:0] haddr_i,
    input  wire      [1:0] htrans_i,            // 2'b00 IDLE, 2'b10 NONSEQ (this core)
